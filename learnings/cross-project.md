...
**Purpose:** durable insights that apply beyond the originating project. Auto-populated by per-project sync scripts.

**Format:** each entry retains its original date and severity. The `PROMOTE TO CLAUDIOUS` line carries the generalized lesson.
