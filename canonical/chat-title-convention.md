...
- `2026-04-20 — MASTERY — PWA Strategy: ASF Graphics + Courtside Pro`
...
- All chats from a date: filter by YYYY-MM-DD prefix
- All chats for a project: filter by project code
- All chats on a topic: free text search on topic field
