...
**File:** archive/proposals/operating-model-5-parts.md
**Summary:** Emerging "OS for AI dev" framework (community): (1) keep always-on context small, (2) procedures → skills/commands, (3) protect active sessions from context pollution, (4) parallelize only with supe
**Why proposal:** (see file)
**Logan action:** review + approve/reject
